...
// AssetsERC20 package used in SNOW Network in terms of GPLv3.
//
...
/// 1024-2047 Precompiles that are not in Ethereum Mainnet but are neither SNOW specific
/// 2048-4095 SNOW specific precompiles
